...
export default {
  ...
  you: "Tú",
  labels: "Tipo de Caso",
  create_new_label: "Crear tipo de caso",
  ...
  no_labels_yet: "Aún no hay tipos de caso",
  ideal: "Ideal",
  current: "Actual",
  ...
  label: {
    select: "Seleccionar tipo de caso",
    create: {
      success: "Tipo de caso creado correctamente",
      failed: "Error al crear el tipo de caso",
      already_exists: "El tipo de caso ya existe",
